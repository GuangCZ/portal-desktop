...
import type { ChatProxy } from './proxy';
...
const CHAT_CONTENT_SECURITY_POLICY = "default-src 'none'; script-src 'self' 'unsafe-inline'; style-src 'self' 'unsafe-inline'; img-src https: data: blob:; connect-src 'self'; font-src 'self'; base-uri 'none'; form-action 'none'; frame-src 'none'";
const CHAT_ASSETS = new Set(['loom.html', 'vendor.js', 'highlight.css', 'chat.css', 'chat-index.js', 'chat-activity.js', 'chat-scene.js']);
