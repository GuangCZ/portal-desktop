...
const CHANNELS = [
  ...
  // The sidebar ledger's three (I6, docs/migration/i6-shell-state.md): this list
  // is every channel `installDesktopExtensions` registers, not only chat's.
  "beings:sidebar-state", "beings:sidebar-action", "beings:sidebar-project-add",
];
